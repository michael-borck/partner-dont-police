# Assessment AI Stress Test: A Prompt Sequence {#sec-stress-test}
...
For more on the engagement spectrum as a conceptual framework for assessment design, see @sec-engagement-spectrum.
...
## Prompt 8: The Honesty Test {#sec-honesty-test}
...
For more on the process-over-product marks split, see @sec-marks-split.
...
For more on why this matters for assessment design, see @sec-notebooklm-infrastructure.
