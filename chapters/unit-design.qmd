...
- **AI integration:** Students use AI for literature synthesis and draft feedback (the Self-Assessment chapter model)
...
- Complete the "Getting Started" tutorial (the Getting Started chapter exercise)
...
Your unit doesn't exist in isolation. It is part of a degree programme.
...
Students need to understand the pedagogical design, because it helps them engage meaningfully.
...
::: {.callout-tip title="Example: Accounting: Advanced Audit and Assurance"}
**Learning Outcomes (AI-Neutral):**
