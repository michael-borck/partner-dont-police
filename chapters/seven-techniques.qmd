...
Each technique is easy to adapt and can be used by students directly or by you to generate teaching materials.

These seven techniques are adapted from the eight techniques in *Conversation, Not Delegation*, which covers the same approaches for a general professional audience. This chapter reframes them for business education, with discipline-specific prompts and teaching guidance. If you want the underlying rationale for why each technique works, or the eighth technique (Risk Deep-Dive), see the companion book.

Let's explore each one with ready-to-use examples.
...
## HR
- "I need to design an onboarding programme for graduate hires. Ask me questions to ensure I've thought through all the key elements."
...
- "I need to design a customer loyalty programme. What questions should I be asking to ensure it's viable and profitable?"
...
- "analyse different IT governance models: centralised, decentralized, federated. What are the trade-offs for control, innovation, and efficiency?"
