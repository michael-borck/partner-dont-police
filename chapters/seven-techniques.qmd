...
Each technique works across all business disciplines. The examples below use different disciplines to show the range, so adapt the prompts for your own field.
