...
::: {.callout-tip title="Example: Accounting"}
```
...
## The Two-Chat Workflow: Separate Thinking from Building
...
### Example: Redesigning an Assessment
...
::: {.callout-important title="You are the bridge"}
...
- **You're teaching students to use AI** (modelling good context management)
...
5. **summarise and handoff** - When conversations get long (50+ exchanges), reset with a summary
...
- Model managing long conversations (summarise, start fresh)
