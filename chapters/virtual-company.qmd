...
This is the simplest version, essentially an enhanced version of the conversation simulation from the Seven Techniques chapter, but with richer organisational context.
...
::: {.callout-tip title="Example: Accounting — Multiple Stakeholder Personas"}
