...
> Case studies tell students what happened. Simulations let them discover what they would do, and why it matters.
...
- recognising the difference between perception and fact
...
- recognise the underlying issues (inadequate management training, unclear performance standards)?
...
2. **analyse the evidence** from all perspectives
...
- recognising systemic issues (weak management processes) vs. individual problems
...
- recognise what information is missing
...
- **Month 5-6:** Performance tracking and optimisation recommendations
...
Month 4 (NOW): You're preparing optimisation recommendations. The marketing budget for next quarter depends on demonstrating ROI from your analytics work.
...
| 9-10 | Off-season transition | Cost optimisation and strategic planning |
...
**Context:** An IT department managing a major system implementation across the organisation.
...
- Will advocate for patients but recognises business realities
...
- Emphasise brand consistency and campaign ROI
...
**Business Analytics:**
- Emphasise data quality, methodology, and interpretation
...
Adapt the grading rubric to emphasise discipline-specific competencies while maintaining core HR/management skills like communication, analysis, and stakeholder management.
...
This is what virtual company simulations can achieve. It does not replace traditional teaching. It adds a layer of experiential learning that was previously impossible at scale.
