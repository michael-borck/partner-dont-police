...
**Integrity-resistant design:** "Based on your earlier [simulation/analysis/project], analyse how [concept] would address the specific situation while meeting [organizational/business requirement]."
- Requires integration of previous personalized work
- Context is unique to each student
- Generic AI response won't fit

**Examples by discipline:**
- HR: "Based on your PIP simulation with Jamie, analyze flexible work approaches"
- Finance: "Based on your company analysis, evaluate investment timing strategies"
- Supply Chain: "Based on your supplier evaluation, analyze relationship strategies"
...
> "You used AI to analyze exit interview data and generate turnover reduction recommendations. You presented them to senior management and implemented them. Six months later, turnover has increased.
>
