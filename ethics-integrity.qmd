...
## The Problem with Detection {#sec-problem-with-detection}
...
**Enterprise/Approved Tools** (e.g., MS Copilot Enterprise, institutional Google Gemini)
...
**The Student Reality**
While you may recommend (or require) students use your institution's approved tool, students will inevitably use other tools:
...
- Course materials and institutional data should be processed through the approved enterprise tool
- Student assignments containing course content are safer in enterprise-protected environments
- Sensitive institutional information should never go into consumer LLMs
- Teaching students to use enterprise tools is teaching them to work like professionals
...
- "Use the institutional AI tool for this assignment (login with your university credentials)"
- "You may use any AI tool for brainstorming, but final analysis should use the approved enterprise tool"
...
- Prepared prompts in the approved enterprise tool
...
- **Response:** Not acceptable for this assignment. Use the approved enterprise tool, or anonymize first.
...
As an educator, you can reference:
- Your institution's Data Governance Policy
- The terms of your enterprise AI licence
...
### Concern: "What about group work? Students can hide behind each other"
...
- Professional accreditation bodies are recognising AI literacy as essential
...
## The Integrity Principle Worth Keeping {#sec-integrity-principle}
...
## Conversation, Not Delegation: The Real Equity Question
...
### The Conversational Nudge as Protection
...
**Experience Standardisation Crisis:** AI optimisation makes tourism experiences so standardised and personalised that authentic cultural exchange disappears, destroying the very value tourists seek.
...
**Classroom Activity:**
> "Your organisation's board asks you to prepare a risk briefing on AI-related threats. Focus on Grey Swan events that are predictable but often neglected. Present your analysis and recommendations for mitigation strategies."
...
**Next Section Preview:** The Appendices provide ready-to-use resources: a prompt library you can copy and adapt immediately, a one-hour workshop guide for introducing these ideas to colleagues, and a framework for aligning AI integration with your institution's learning outcomes.
